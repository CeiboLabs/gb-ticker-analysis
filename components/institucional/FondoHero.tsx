  ...
  return (
    <header className="ffac-hero" ref={heroRef}>
      ...
      <style>{`
        ...
        .ffac-stage { position: absolute; inset: 0; z-index: 0; }
        ...
        @media (max-width: 920px) {
          ...
          /* La firma sube al cuadrante superior y hace de marca; el eyebrow
             repetiría "BNG Selección Global" justo debajo → lo ocultamos. */
          .ffac-sign { top: clamp(150px, 26vh, 240px); left: 50%; }
          .fh-eyebrow { display: none; }
          .ffac-scrim {
